...
export default function PlayerEditorPage() {
  ...
  const fetchFile = useCallback(async () => {
    ...
    setLoadError('');
    try {
      const res = await fetch(`/api/admin/github?path=${encodeURIComponent(filePath)}`);
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', flexWrap: 'wrap' }}>
            ...
            <button
              ...
              style={{
                background:
                  loadingFile || saveStatus === 'saving' || !sha ? '#6B7280' : '#C41E3A',
                color: '#E8E8E8',
                border: 'none',
                ...
                textTransform: 'uppercase',
                cursor:
                  loadingFile || saveStatus === 'saving' || !sha ? 'not-allowed' : 'pointer',
