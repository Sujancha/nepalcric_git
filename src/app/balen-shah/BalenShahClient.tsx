    ...
    return (
        <div className="w-full min-h-screen bg-[#0A0A0A] text-[#F0EDE8] overflow-x-hidden" style={{ scrollBehavior: 'smooth' }}>
            ...
            <Section label="पुनर्जन्म">
                ...
                <P>चार पटकका प्रधानमन्त्री। झापाको अभेद्य किल्ला। २००८ देखि एकछत्र राज। केपी ओली। बालेनसँग सजिलो ठाउँहरू थिए — काठमाडौंमा जित्न सकिन्थ्यो। तर उनले भने: &ldquo;मैले कानुनी रूपमा जेन-जी को लागि गर्न सक्ने भनेको यही नै हो।&rdquo; सत्तर सात जनाले ज्यान दिएका थिए। उनीहरूको रगतको कर्जा चुकाउन — बालेनले सबैभन्दा कठिन ठाउँ रोजे। यो जित होइन। यो ट्रिब्युट हो।</P>
                <P>चार वर्षपछि उनले अर्को युद्ध लडे। झापा-५। चार पटकका प्रधानमन्त्री केपी शर्मा ओलीको अभेद्य किल्ला। काठमाडौंबाट ३०० किलोमिटर टाढा। सजिलो ठाउँ छोडेर कठिन ठाउँ रोजे। किनभने सन्देश पठाउनु थियो।</P>
                <P>मतगणना सकियो —</P>
                <Isolated large gold>बालेन शाह — ६८,३४८<br />केपी शर्मा ओली — १८,७३४<br />फरक — ४९,६१४ मत।</Isolated>
