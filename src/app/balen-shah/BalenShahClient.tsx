    ...
    return (
        <div className="w-full min-h-screen bg-[#0A0A0A] text-[#F0EDE8] overflow-x-hidden" style={{ scrollBehavior: 'smooth' }}>
            ...
            <Section label="सुरुवात" first={true}>
                ...
                <PullQuote attribution="— बालेन्द्र शाह, रअ बार्ज, २०१३">
                ...
                <P>उनले मुख खोलेनन्। ओठ थिचे। ढाड सोझो राखे। त्यो कोठामा &ldquo;मधेशी&rdquo; भन्ने शब्द कसरी अवतरण हुन्थ्यो उनलाई थाहा थियो — त्यो हाँसो, त्यो हेराइ। त्यसैले उनले केही भनेनन्।</P>
            ...
            <Section label="बाल्यकाल">
                ...
                <P>विद्यालयको बसको धमिलो सिसाबाट उनी काठमाडौंको सडक हेर्थे। त्यहाँ देख्थे — च्यातिएका लुगा लगाएका बालबालिका, फोहोरका थुप्रोमा केही खोज्दै हिँड्ने सानासाना हातहरू, जसले कहिल्यै विद्यालयको ढोका देखेका थिएनन्। उनी त्यो सिसाबाट आँखा उठाउन सक्थेनन् — र उठाए पनि बसको छाना उनले देख्थे, जहाँ जवाब थिएन। हात मुट्ठी परिन्थे। तर के गर्ने थाहा थिएन।</P>
