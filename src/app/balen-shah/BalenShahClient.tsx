        ...
        <div className="w-full min-h-screen bg-[#0A0A0A] text-[#F0EDE8] overflow-x-hidden" style={{ scrollBehavior: 'smooth' }}>
            ...
            <Section label="सुरुवात" first={true}>
                ...
                <p className="mb-[1.8em] clear-left">
                    बालेनले मुख खोलेनन्। ओठ थिचे। ढाड सोझो राखे। माइक्रोफोन अझ कसेर समाते। उनलाई थाहा थियो — &ldquo;म मधेशी हुँ&rdquo; भन्ने बित्तिकै के हुन्छ। त्यो शब्द त्यस कोठामा कुन रूपमा अवतरण हुन्थ्यो। त्यो हाँसो। त्यो हेराइ। त्यसैले उनले केही भनेनन्।
                </p>
            ...
            <Section label="पुनर्जन्म">
                ...
                <P>बाहिर हजारौं युवाको चिच्याहट आकाश चिर्यो।</P>
                ...
                <P>मतगणना सकियो —</P>
                <Isolated large gold>बालेन शाह — ६८,३४८ &nbsp;·&nbsp; केपी शर्मा ओली — १८,७३४ &nbsp;·&nbsp; फरक — ४९,६१४ मत।</Isolated>
