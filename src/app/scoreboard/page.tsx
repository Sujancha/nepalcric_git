...
const archives = [
    {
        ...
        year: "२०१४",
        outcome: "नेपालको पहिलो विश्वकप — ढाकाको त्यो ऐतिहासिक पाइला",
        matches: [
            { opponent: "अफगानिस्तान", date: "मार्च", result: "नेपाल पराजित — इतिहासको सुरुवात" },
            { opponent: "हङकङ", date: "मार्च", result: "नेपाल विजयी — पहिलो विश्वकप जित" },
            { opponent: "पाकिस्तान", date: "मार्च", result: "नेपाल पराजित — तर अविस्मरणीय लडाइँ" },
        ],
    },
    {
        id: "odi-status-2018",
        seriesName: "नेपालको ओडीआई मान्यता — पहिलो आधिकारिक एकदिवसीय",
        year: "२०१८",
        outcome: "इतिहास रचियो — नेपाल आधिकारिक ओडीआई राष्ट्र बन्यो",
        matches: [
            { opponent: "नेदरल्यान्ड्स", date: "अगस्त १", result: "नेपालको पहिलो आधिकारिक ओडीआई — एउटा युगको सुरुवात" },
            { opponent: "नेदरल्यान्ड्स", date: "अगस्त ३", result: "दोस्रो ओडीआई — इतिहासको दोस्रो पृष्ठ" },
        ],
    },
    {
    ...
    },
    {
        ...
        year: "२०२३",
        outcome: "११/१२ — रोहितको नेतृत्वमा असम्भव भएन",
        matches: [
