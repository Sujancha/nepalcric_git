...
export default function LockerRoom() {
    ...
    const vaultVideos = [
        ...
        {
            id: "vid-04",
            title: "१२औं खेलाडी: टीयू ग्राउन्डको हुटिंग",
            duration: "५:२०",
            date: "०५ मार्च २०२६",
            thumb: "https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
        },
        {
            id: "vid-05",
            title: "रोहित पौडेल: द क्याप्टेन्स नक",
            duration: "६:१०",
            date: "०१ मार्च २०२६",
            thumb: "https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
        },
    ...
    return (
        <div className="bg-[#07080F] min-h-screen selection:bg-[#C41E3A] selection:text-white pb-32 relative font-sans">
            <Head>
                <title>लकर रुम | NepalCric</title>
                <meta name="description" content="ड्रेसिङ रुमको कथा - Exclusive Locker Room Content" />
            </Head>

            {/* Global Atmosphere: Film Grain */}
            ...
            <section className="relative h-[70vh] w-full overflow-hidden flex flex-col justify-end">
                ...
                <div className="relative z-20 px-6 lg:px-12 w-full max-w-7xl mx-auto pb-16 animate-[fadeUpIn_0.8s_cubic-bezier(0.76,0,0.24,1)_both]">
                    ...
                    <h1 className="text-white text-[clamp(48px,8vw,90px)] leading-[0.9] mb-8" style={{ fontFamily: 'Mukta, sans-serif', fontWeight: 800, letterSpacing: '0' }}>
                        ड्रेसिङ रुमको कथा
                    </h1>
                    ...
                    <button className="flex items-center gap-3 bg-white/10 backdrop-blur-md border border-white/20 px-8 py-4 hover:border-[#C41E3A] hover:bg-[#C41E3A]/20 transition-all duration-300 group">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="white" className="group-hover:text-[#C41E3A] transition-colors">
                            <polygon points="5 3 19 12 5 21 5 3"></polygon>
                        </svg>
                        <span style={{ fontFamily: 'Mukta, sans-serif', fontSize: '18px', fontWeight: 700, letterSpacing: '0', color: 'white' }}>
                            हेर्नुस्
                        </span>
                    </button>
                </div>
            ...
            {/* ZONE 2: THE VIDEO VAULT */}
            <section className="relative z-20 px-6 lg:px-12 w-full max-w-7xl mx-auto mt-12">
                {/* Section Header */}
                <div className="flex items-center mb-8">
                    <span style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '12px', color: '#C9A84C', textTransform: 'uppercase', marginRight: '16px', letterSpacing: '0' }}>
                        दृश्य भण्डार
                    </span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    {vaultVideos.map((video, idx) => {
                        let overlayBg = undefined;
                        let customFilter = undefined;
                        ...
                        return (
                            <div key={video.id} className="flex flex-col group cursor-pointer animate-[dynamicSlideFade_0.6s_cubic-bezier(0.76,0,0.24,1)_both]" style={{ animationDelay: `${idx * 0.1}s` }}>
                                ...
                                <div className="relative aspect-video rounded-sm overflow-hidden bg-[#0a0f16] border border-white/5 mb-4 shadow-lg">
                                    {/* The Image with conditional filtering */}
                                    <div
                                ...
                                {/* Meta Text */}
                                <h3 style={{ fontFamily: 'Mukta, sans-serif', fontSize: '18px', fontWeight: 600, color: '#FFFFFF', letterSpacing: '0', lineHeight: 1.3, marginBottom: '6px' }} className="group-hover:text-[#C9A84C] transition-colors duration-300">
                                    {video.title}
                                </h3>
                                <div className="flex items-center gap-2">
                                    ...
                                    <span style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '13px', color: 'rgba(255,255,255,0.4)', letterSpacing: '0.05em' }}>
                                        {video.duration}
                                    </span>
                                </div>
